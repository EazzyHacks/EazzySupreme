...
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
  ...
  global.owner = [
    [ '51936994155', '𝗘𝗮𝘇𝘇𝘆 𝗦𝘂𝗽𝗿𝗲𝗺𝗲', true ],
  [ '', true ]
  ]
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
...
global.packname = `🐺 𝗘𝗮𝘇𝘇𝘆 𝗦𝘂𝗽𝗿𝗲𝗺𝗲 🐺`
global.author = '𝗕𝗿𝘅𝘇𝘇_𝘅𝗶𝘁 🐺'
global.stickpack = '𝐂𝐫𝐞𝐚𝐬𝐭𝐞 𝐔𝐧 𝐒𝐭𝐢𝐜𝐤𝐞𝐫 𝐂𝐨𝐧 𝐄𝐚𝐳𝐳𝐲 𝐒𝐮𝐩𝐫𝐞𝐦𝐞 🐺'
global.stickauth = '�𝐁𝐲 : 𝐁𝐫𝐱𝐳𝐳_𝐱𝐢𝐭 🐺'
global.wm = '🐺 𝐄𝐚𝐳𝐳𝐲 𝐒𝐮𝐩𝐫𝐞𝐦𝐞 𝐌𝐞𝐣𝐨𝐫 𝐁𝐨𝐭 🐺'
global.dev = '𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐁𝐲 𝐁𝐫𝐱𝐳𝐳_𝐱𝐢𝐭 🐺'
global.wait = '*𝐏𝐨𝐫 𝐟𝐚𝐯𝐨𝐫 𝐚𝐠𝐮𝐚𝐫𝐝𝐞 𝐮𝐧 𝐦𝐨𝐦𝐞𝐧𝐭𝐨\n\n𝗘𝗮𝘇𝘇𝘆 𝗦𝘂𝗽𝗿𝗲𝗺𝗲 🐺*'
global.botname = '𝐄𝐚𝐳𝐳𝐲 𝐎𝐧𝐥𝐢𝐧𝐞 𝟐𝟒𝐇𝐬 🐺'
global.textbot = `𝐓𝐞𝐜𝐧𝐨𝐥𝐨𝐠𝐢𝐬 𝐛𝐲 𝗘𝗮𝘇𝘇𝘆 𝗦𝘂𝗽𝗿𝗲𝗺𝗲 🐺`
global.dev = '𝐒𝐨𝐟𝐭𝐰𝐚𝐫𝐞 𝐁𝐲 𝗘𝗮𝘇𝘇𝘆 𝗦𝘂𝗽𝗿𝗲𝗺𝗲 🐺'
global.listo = '*𝐄𝐱𝐢𝐭𝐨*'
global.namechannel = '🐺 𝐄𝐚𝐳𝐳𝐲 𝐒𝐮𝐩𝐫𝐞𝐦𝐞 𝐌𝐞𝐣𝐨𝐫 𝐁𝐨𝐭 🐺'
